...
{
    private GreenfootImage img; //imatge que representarà aquest peixet
    private int distancia; // disatància que ha de desplaçar-se cap amunt i cap avall
    private int desplacament; //la distància que duu desplaçada
    private boolean estaBaixant; //El sentit del moviment (cap amunt, cap avall)
